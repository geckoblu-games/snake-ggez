...
impl GridPosition {
    ...
    pub fn to_direction(&mut self, dir: Direction) {
        match dir {
            Direction::Down => {
                self.y += 1;
...
impl From<GridPosition> for Vec2 {
    fn from(pos: GridPosition) -> Self {
        Vec2::new((CELL_SIZE * pos.x) as f32, (CELL_SIZE * pos.y) as f32)
    }
}
...
impl MyGame {
    pub fn new(ctx: &mut Context) -> GameResult<MyGame> {
        ...
        let head_pos = GridPosition::new(6, 0);
...
impl EventHandler for MyGame {
    ...
    fn draw(&mut self, ctx: &mut Context) -> GameResult {
        ...
        // Draw the snake head
        // convert to pixel
        let head_dest: Vec2 = self.head_pos.into();
